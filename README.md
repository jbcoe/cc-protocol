...
Write your concrete type. It does **not** inherit from `xyz::B`. It only needs to structurally provide the methods defined in the interface.
...
Because the generated wrapper relies heavily on C++20 `requires` clauses, any structural mismatch emits clear, pinpointed compile-time errors rather than deeply nested template instantiation failures.
